...
import { gsap, ScrollTrigger, setupGsap, scheduleScrollRefresh } from "./gsap-runtime";
    ...
    media.add(
      ...
      (context) => {
        ...
        if (desktop) {
          ...
          gsap.set(steps, { autoAlpha: 0, y: 70, scale: 0.96 });
          gsap.set(firstStep, { autoAlpha: 1, y: 0, scale: 1 });
          ...
          entrance
            ...
            .from(element.querySelector(".process-introduction"), { opacity: 0, y: 24, duration: 0.65 }, 0.52)
            ...
            .from(firstStep.querySelector(".process-step-description"), { opacity: 0, y: 20, duration: 0.65 }, 0.68)
          ...
          for (let index = 0; index < steps.length - 1; index++) {
            ...
            const at = index + 0.64;
            sequence
              .to(current, { autoAlpha: 0, y: -58, scale: 0.975, duration: 0.3 }, at)
              .fromTo(next,
                { autoAlpha: 0, y: 78, scale: 0.955 },
                { autoAlpha: 1, y: 0, scale: 1, duration: 0.34 }, at + 0.04)
              ...
              .fromTo(next.querySelector(".process-step-description"), { opacity: 0, y: 24 }, { opacity: 1, y: 0, duration: 0.26 }, at + 0.19)
          ...
          revealTimelines.push(createCinematicReveal({
            ...
            steps: [
              ...
              { targets: element.querySelector(".process-introduction")!, from: { opacity: 0, y: 24 }, to: { duration: 0.62 }, at: 0.43 },
