    ...
    <section id="faq" className="faq" aria-labelledby="faq-title" tabIndex={-1}>
      ...
      <div className="faq-layout">
        <header className="faq-intro">
          ...
          <a className="faq-contact" data-faq-intro="contact" href={`${profile.whatsapp}?text=${encodeURIComponent(copy.more)}`} target="_blank" rel="noopener noreferrer"><span>{copy.contact}</span><ArrowIcon /></a>
