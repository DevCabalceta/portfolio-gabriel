...
const es = {
  siteFooter: {
    ...
    titleLabel: "El siguiente capítulo.",
    ...
    credit: "DISEÑADO Y DESARROLLADO POR GABRIEL CABALCETA",
  },
  contactSection: {
...
const en: Dictionary = {
  siteFooter: {
    ...
    role: "FULL STACK DEVELOPER · COSTA RICA",
    credit: "DESIGNED AND DEVELOPED BY GABRIEL CABALCETA",
  },
  contactSection: {
