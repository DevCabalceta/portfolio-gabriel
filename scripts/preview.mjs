...
await page.locator('.hero-robot[data-ready="true"]').waitFor({ timeout: 90000 });
...
await page.waitForFunction(() => [...document.querySelectorAll("[data-about-char]")].every((element) => getComputedStyle(element).opacity === "1"));
...
await page.screenshot({ path: "artifacts/about-profile-mobile.png" });
await browser.close();
